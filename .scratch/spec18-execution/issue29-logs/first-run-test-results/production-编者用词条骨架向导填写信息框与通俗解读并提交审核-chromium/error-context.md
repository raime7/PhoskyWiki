...
- Name: production.spec.ts >> 编者用词条骨架向导填写信息框与通俗解读并提交审核
- Location: tests\e2e\production.spec.ts:5:5
...
- main:
  ...
  - textbox "名称":
    ...
    - text: T15向导编者
  - text: 邮箱
  - textbox "邮箱": t15-wizard-93dd3d51-2253-4616-a771-f51f98843937@example.com
  - text: 密码（至少 8 位）
