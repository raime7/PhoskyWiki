...
export function TermMetadataDiff({ from, to }: { from: TermSnapshot; to: TermSnapshot }) {
  return <div className="overflow-x-auto" data-testid="term-metadata-diff">
    <table className="w-full border-collapse text-sm">
      <thead><tr><th className="p-2 text-left">字段</th><th className="p-2 text-left">当前版</th><th className="p-2 text-left">提案</th></tr></thead>
