...
// 含编委会通俗视角、跨词条双链、红链；T04 增补：显式视角链接、消歧义双义示例）。
//
...
在意识形态问题上，拉康的框架后来被阿尔都塞借用：意识形态把个体询唤为主体，正是一种镜像式的误认。可参照[[意识形态]]词条下阿尔都塞的视角；主体与对象颠倒的问题亦见[[异化]]。若想看[[镜像阶段]]作为独立概念的展开，该词条尚待撰写——这是一个写作缺口。同样尚待撰写的还有弗洛伊德本人的奠基性视角[[主体性|弗洛伊德论主体性@弗洛伊德]]。`,
  },
  {
    term: "主体性",
    interpreter: "阿尔都塞",
